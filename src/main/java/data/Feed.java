 ...
 */
public class Feed {
    static final String [] USUARIOS = {"carlos", "laura", "pedro","maria","ricardo","sofia", "usuario", "usuarioo", "usuariooo"};
    static final int CANTREGISTROS = 1000000;
    static final String FECHAINICIO = "2014-09-15 15:03:23";
    static final String FECHAFIN = "2016-09-15 15:03:23";
    static final String NOMBRE_ARCHIVO = "/home/juan/Documentos/unco/Analisis de algoritmos/AnalisisAlgoritmosMaven/src/main/java/data/log.txt";
    ...
    public static String[] leerArchivoParcial(int cant_reg){
    	String [] arreglo = new String[cant_reg];
    	try{
    		BufferedReader buff = new BufferedReader(new FileReader(NOMBRE_ARCHIVO));
    		for (int i = 0; i < cant_reg  ; i++)arreglo[i] = buff.readLine();
                buff.close();
    	}
    	catch (FileNotFoundException ex) {
    		System.err.println(ex.getMessage() + "\nEl archivo de lectura no existe.");
