 ...
 */
public class Utiles {
    static final String NOMBRE_ARCHIVO = "/home/juan/Documentos/unco/Analisis de algoritmos/AnalisisAlgoritmosMaven/src/main/java/data/radix.txt";
    ...
    public static long[] convertToLong(String[] arr) {
    ...
    public static long[] invertido(long[] a) {
	long [] inv = a.clone();
	int l = a.length;
	long temp;
    ...
    public static long[] medirEmpirico(int[]escalas){
        ...
        try {
            ...
            for (int i=0;i<escalas.length;i++){
                ...
                main.Radix.ordenarRadix(logRadix, logRadix.length);
